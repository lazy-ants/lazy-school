...
export const I18nLocales: { en: I18nLocale; ru: I18nLocale } = {
    en: {
        language: 'en',
        country: 'GB',
        currency: 'GBP',
...
const l10nConfig: L10nConfig = {
    locale: {
        languages: [
            ...
            {
                code: I18nLocales.ru.language,
                dir: 'ltr',
            },
        ],
        defaultLocale: {
            languageCode: I18nLocales.ru.language,
            countryCode: I18nLocales.ru.country,
        },
        currency: I18nLocales.ru.currency,
